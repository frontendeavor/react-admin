...
const TransferPage: React.FC = () => {
  ...
  const onSelectChange = (sourceSelectedKeys: React.Key[], targetSelectedKeys: React.Key[]) => {
    const sources = sourceSelectedKeys as string[]
    const targets = targetSelectedKeys as string[]

    setSelectedKeys([...sources, ...targets])
  }
  ...
  const handleChange = (nextTargetKeys: React.Key[]) => {
    setTreeTargetKeys(nextTargetKeys as string[])
  }
                ...
                if (direction === 'left') {
                  ...
                  return (
                    <Tree
                      ...
                      onCheck={(_, { node: { key } }) => {
                        onItemSelect(key as string, !isChecked(treeCheckedKeys as string[], key as string))
                      }}
                      onSelect={(_, { node: { key } }) => {
                        onItemSelect(key as string, !isChecked(treeCheckedKeys as string[], key as string))
                      }}
